...
public class Bird
{
    ...
    {   
        ...
        if(pa.mouseX >= birdX)
        {
            ...
            pa.arc(x - 70, y + 19.5f, 80, 80, 0, pa.PI, pa.OPEN); // body

            pa.stroke(0);
            pa.arc(x - 90, y + 29.5f, 50, 50, 0, pa.PI, pa.CHORD); // wing
        ...
        else
        {
            ...
            pa.arc(pa.mouseX + 70, y + 19.5f, 80, 80, 0, pa.PI, pa.OPEN); // body

            pa.stroke(0);
            pa.arc(pa.mouseX + 90, y + 29.5f, 50, 50, 0, pa.PI, pa.CHORD); // wing
    ...
    public void render(PApplet pa, float x, float time)
    {
        ...
        if(pa.mouseX >= birdX)
        {
            ...
            pa.arc(birdX - 70, birdY + 19.5f, 80, 80, 0, pa.PI, pa.OPEN); // body

            pa.stroke(0);
            pa.arc(birdX - 90, birdY + 29.5f, 50, 50, 0, pa.PI, pa.CHORD); // wing
